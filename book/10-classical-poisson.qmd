...
Let's now predict on the test set. Besides the residual deviance discussed in [Goodness of fit](#goodness), the model performance can also be measured by Kullback-Leibler (KL) divergence, which is defined as
$$
