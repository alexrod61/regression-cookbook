...
plt.hist(train_data["Net_Money"].dropna(), bins=8, color="navy", edgecolor="white")
plt.title("")
plt.xlabel("Net Money")
plt.ylabel("Frequency")
plt.show()
...
<!--   scale_x_continuous(breaks = seq(-1500, 2000, by = 500)) + -->
<!--   scale_y_continuous(breaks = seq(0, 50, by = 10)) -->
...
<!-- # Drop missing values -->
<!-- net_money = train_data["Net_Money"].dropna() -->

<!-- # Create figure (match aspect ratio) -->
<!-- plt.figure(figsize=(14, 8)) -->

<!-- # Histogram -->
<!-- plt.hist(net_money, bins=40, color="navy", edgecolor="white") -->

<!-- # Labels -->
<!-- plt.xlabel("\n Net Money (CAD)", fontsize=20) -->
<!-- plt.ylabel("Count\n", fontsize=20) -->
<!-- plt.title("Histogram of net money via training set.", fontsize=18) -->

<!-- # Axis ticks (match R logic) -->
<!-- plt.xticks(np.arange(-1500, 2001, 500), fontsize=15) -->
<!-- plt.yticks(fontsize=15) -->

<!-- # Limits (based on your summary) -->
<!-- plt.xlim(-1800, 2000) -->

<!-- # Clean style similar to theme_bw() -->
<!-- plt.grid(False) -->
