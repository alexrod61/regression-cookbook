...
plt.boxplot(train_data["Net_Money"].dropna(), patch_artist=True,
            boxprops=dict(facecolor="lightblue"))
plt.title("Boxplot of Net Money")
plt.ylabel("Net Money")
plt.xticks([1], [""])  # Remove x-axis label/number
plt.tight_layout()
plt.show()
```
:::
...
$$
\begin{align*}
\text{Net\_Money} &= -595.37 \\
&\quad + 73.93 \times \text{Has\_Job} \\
&\quad - 499.36 \times \text{Financially\_Dependent} \\
&\quad - 96.52 \times \text{Year\_of\_Study} \\
&\quad - 54.60 \times \text{Goes\_Out\_Spends\_Money} \\
&\quad - 145.11 \times \text{Drinks\_Alcohol} \\
&\quad + 1.47 \times \text{Monthly\_Allowance} \\
&\quad + 0.95 \times \text{Monthly\_Earnings} \\
&\quad + 102.95 \times \text{Living\_Situation} \\
&\quad + 56.65 \times \text{Housing\_Type} \\
&\quad - 96.31 \times \text{Cooks\_at\_Home} \\
&\quad + \epsilon
\end{align*}
$$
