...
```{r}
#| label: fig-barplot-living-situation
...
```{r}
#| label: fig-net-money-correlation-matrix
...
```{r}
#| label: fig-scatter-plot-allowance-net-money
...
```{r}
#| label: fig-box-plot-net-money-living-situation
