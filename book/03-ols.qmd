...
To answer this, the questions below will guide you through an OLS analysis on this data.
...
### C. Data Modelling - Improvements {.unnumbered}
...
## R Code
```{r}
# C.1 prior_courses is an integer. We can try convert prior_courses to categorical and fit the model again:
...
# C.2 Log transform hours_studied and fit model
...
# C.2 Log transform hours_studied
...
# D.2 Interpretation of final model (model3)
...
# D.3 Diminishing returns explanation
