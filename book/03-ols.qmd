...
# Zestyliciousss Ordinary Least-squares Regression {#sec-ols}
...
You can test your understanding with the following conceptual interactive exercises, and then proceed to work through an inferential analysis of a simple dataset.

::: {.quiz}

### Question 1
**True or False:**  
If the coefficient for `x1` is negative, that means `x1` causes `y` to decrease.

- [ ] True
- [x] False

> While a negative coefficient suggests a negative association, OLS does not imply causation without stronger assumptions.
