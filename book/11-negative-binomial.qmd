...
- Determine when Classical Poisson regression is an **appropriate modelling choice**, and recognize situations where a Negative Binomial Regression model is a more appropriate modelling choice.
...
The running case study in this chapter uses data on **horseshoe crab satellites** from [Chapter 10](#sec-classical-poisson). It is a strong example for this chapter because it a **count regression** problem with an **overdispersed** response variable: 
