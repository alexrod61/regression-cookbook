...
``` {.python}
#import statsmodels.api as sm
#from statsmodels.stats.diagnostic import het_overdispersion
...
# Overdispersion test
#stat, pvalue = het_overdispersion(results)
...
```{.r}
negative_binomial_model <- glm.nb(satellites ~ width_cm + weight_kg + color + spine,
  data = training_data
)
