...
display_tbl["estimate"] = [
    f"{est:.4f}" if kind == "coefficient" else f"{est:.1f}"
    for est, kind in zip(tidy_ordinal["estimate"], tidy_ordinal["coef.type"])
]
display_tbl["std.error"] = display_tbl["std.error"].round(2)
display_tbl["statistic"] = display_tbl["statistic"].round(1)
