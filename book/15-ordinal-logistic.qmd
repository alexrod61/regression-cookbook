...
- The outcome variable is continuous or a count. For continuous and unbounded outcomes, refer to ordinary least-squares regression (@sec-ols); for count outcomes, refer to the count regression models, such as Poisson regression (@sec-generalized-poisson).
