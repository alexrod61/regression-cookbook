...
|---|---|---|---|---|---|
| Inclination to Apply to Graduate School | How inclined the student is to apply to graduate school | Discrete | Ordinal | Response | `inclination_to_apply` |
...
| Field of Study | The student's undergraduate field of study | Discrete | Categorical | Regressor | `field_of_study` |
...
### Regressors Associated with Inclination to Graduate School
