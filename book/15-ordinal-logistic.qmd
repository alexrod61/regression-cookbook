    ...
    for bar in bar_group:
        ...
        if h >= 0.05:
            ax.text(
                ...
                f'{h:.0%}',
                ha='center', va='center',
                color='firebrick', fontweight='bold', fontsize=12
            )
...
$$
F(\eta) = \frac{e^{\eta}}{1 + e^{\eta}}, \qquad \text{with systematic component} \quad \eta_j = \alpha_j - \boldsymbol{\beta}^\top \underline{x},
$$
...
2. Repeat until convergence:
   - Compute the systematic components $\alpha_j - \boldsymbol{\beta}^\top \underline{x}_i$ for all $i$ and $j$.
