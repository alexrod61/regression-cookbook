...
To see what this looks like concretely, consider an example with $J = 3$ ordered categories. Here $j$ runs over the values $1, 2, \ldots, J - 1 = 2$, so there are two cumulative probabilities to form:
...
# the Normal-approximation p-values. We keep the slope coefficients only
