...
For numerical optimization, Newton–Raphson method proceeds identically to the proportional odds case, but the score and Hessian are now computed with respect to all $(J-1)(k+1)$ parameters. As the cumulative logits are no longer coupled through a single $\boldsymbol{\beta}$, the Hessian has a more favourable block structure. In principle, each cumulative logit can be optimized independently, although software typically optimizes all parameters jointly.
::::
:::
