...
The estimation step is a fundamental part of the data modeling process, where the theoretical model is applied to the training data to derive concrete parameter estimates. Using R or Python, we fit the model and obtain estimates that quantify the effects of the predictors. This systematic approach, as visualized in @fig-ds-workflow-estimation, lays the groundwork for further analysis and interpretation, which we will expand upon in the subsequent sections.
