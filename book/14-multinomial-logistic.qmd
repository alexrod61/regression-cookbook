...
|---|---|---|---|---|---|
| Inclination to Apply to Graduate School | The primary mode of transport used by the individual | Nominal | Response | `transport_mode` |
...
head(multinomial_transport, n = 100) |>
  print_as_dt()
```
...
_ = plt.title("Confusion Matrix (Training Set)")
plt.tight_layout()
plt.show()
```
...
_ = disp.plot(cmap="Blues")
_ = plt.title("Confusion Matrix (Test Set)")
plt.tight_layout()
plt.show()
```
