...
- Evaluate model performance using **accuracy**, **confusion matrices**, and **cross-validation**, and construct confidence intervals using **Wald Z statistic**.
::::
:::
