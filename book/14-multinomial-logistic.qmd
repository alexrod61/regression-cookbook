...
::::
::::{.Tip-container}
It is important to remember that this analysis is associational, not causal. The model does not show that changing someone's commute distance or car access would, on its own, change how they travel; it shows that, in this dataset, these regressors are consistently linked to the mode people choose once other measured factors are accounted for.

Nevertheless, the results provide a useful evidence-based starting point for discussion. They help identify which regressors are most strongly linked to travel mode choice, and which associations — such as age and weekend commuting for the rarer categories — may only become visible with more balanced or more abundant data. For transportation planners, this kind of insight can help prioritize where infrastructure investment, such as bike lanes or improved transit access, is likely to shift commuting patterns the most.
::::
:::
