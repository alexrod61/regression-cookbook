...
This regression approach assumes a [Multinomial distribution](https://www.sciencedirect.com/topics/computer-science/multinomial-distribution) where $p_{i,1},p_{i,2},\dots,p_{i,m}$ are the probabilities that will belong to categories $1,2,\dots,m$ respectively; i.e., 
