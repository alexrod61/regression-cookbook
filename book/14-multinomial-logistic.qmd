...
$$
where $k\in\{$ Bicycle, Public Transit, Walking $\}$ and $X_{1,i},X_{2,i},X_{3,i},X_{4,i}$ represent age, commute distance, car availability, and weekend commuter indicator respectively.
