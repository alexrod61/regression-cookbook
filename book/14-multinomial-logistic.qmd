...
- **Inference:** Understand the relationship between the regressor (commute distance) and the probability of each category of the response variable (transport mode), given the confounding effects of age, car availability, and weekend commuter status. 
