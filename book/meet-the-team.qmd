...
> I'm an Assistant Professor of Teaching in the Department of Statistics and the Master of Data Science program at the University of British Columbia. My teaching focuses on helping students build strong statistical reasoning for modern data science, with courses spanning probability, frequentist and Bayesian inference, regression, causal inference, experimentation, and scientific communication. My academic and professional background includes credit risk management, statistical consulting, data science education, and statistical research, with doctoral work focused on computer experiments that use Gaussian stochastic processes, also known as kriging regression, to emulate complex scientific and engineering systems. These experiences shape how I teach regression: not only as a collection of model formulas, but as a structured way of thinking about data, uncertainty, prediction, interpretation, and communication.
...
<center><img src="img/photo-karan.jpg" width=300 /></center>
<br>

> I'm currently a Master of Data Science student at the University of British Columbia. I hold a B.Sc. in Mathematics and an M.Sc. in Applied Mathematics. During my M.Sc., I did a research project on the mathematical modelling of opioid use disorder and treatment in British Columbia. I have a strong interest in both mathematics and teaching. In my free time, I like to go hiking, play chess, listen to music, and watch sitcoms.

## Lavanya Gupta

<center><img src="img/photo-lavanya.png" width=340 /></center>
<br>

> I am currently completing my Master of Data Science at the University of British Columbia, with a background in Computer Engineering from India. My interests sit at the intersection of machine learning and real world decision systems, with a focus on building models that are not just accurate but reliable and interpretable in practice. My research work includes a publication in Multimedia Tools and Applications (2024), applying deep learning to cardiac abnormality diagnosis. Data for me has always been about the people behind the numbers, especially the ones who rarely get counted, and I want to be part of changing that. Outside of work, I volunteer with animal shelters and youth programs and value spending time in community focused environments.
...
## Héctor Palafox Prieto

<center><img src="img/photo-hector.jpg" width=300 /></center>
<br>

> I’m currently completing my Master of Data Science at the University of British Columbia, and I hold a Bachelor's degree in Industrial Engineering by Tecnológico de Monterrey (ITESM). Before UBC, I taught pre-calculus level mathematics and introductory programming at ITESM in Mexico City, working with over 1,000 students and coaching two FIRST Robotics Competition teams (3472 - Buluk from ITESM, and more recently 11391 - Hypatia from Vancouver Independent School for Science and Technology). I enjoy building clear, reproducible data workflows and explaining statistical ideas in a practical way. For the Regression Cookbook, I'm collaborating on the Zero-Inflated Poisson Regression chapter, helping readers model count data with lots of zeros confidently!
