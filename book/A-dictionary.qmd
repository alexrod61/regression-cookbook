...
::::
::::{.Equivalence-container}
`r colourize("Dependent variable", "blue")`, `r colourize("response variable", "blue")`, `r colourize("output", "magenta")` or `r colourize("target", "magenta")`.
::::
:::
...
::::
::::{.Equivalence-container}
`r colourize("Dependent variable", "blue")`, `r colourize("response variable", "blue")`, `r colourize("outcome", "magenta")` or `r colourize("target", "magenta")`.
::::
:::
...
::::
::::{.Equivalence-container}
`r colourize("Dependent variable", "blue")`, `r colourize("response variable", "blue")`, `r colourize("outcome", "magenta")` or `r colourize("output", "magenta")`.
::::
:::
