...
In `r colourize("supervised learning", "magenta")`, it is the main variable of interest we are trying to **learn** or **predict**, or equivalently, the variable we are trying **explain** in a statistical inference framework.
...
`r colourize("Regression analysis", "blue")` is a collection of **statistical methods** used to study the relationship between a `r colourize("response variable", "blue")` and one or more `r colourize("explanatory variables", "blue")`. Its goals may include explaining associations, estimating effects, quantifying uncertainty, or predicting future outcomes.
