...
\end{align*}
$${#eq-proof-binomial-PMF-adds-to-1-a}

On the right-hand side of @eq-proof-binomial-PMF-adds-to-1-a we will add the following factor:
...
\end{align*}
$${#eq-proof-binomial-PMF-adds-to-1-b}
...
\end{gather*}
$$
The above arrangement yields the following result in @eq-proof-binomial-PMF-adds-to-1-b:
...
\end{align*}
$${#eq-proof-binomial-PMF-adds-to-1-c}
