...
$$
\begin{align*} 
\mathbb{E} \left( Y^2 \right) &= 2 \int_{y = 0}^{y = \infty} y \exp{\left( -\lambda y \right)} \mathrm{d}y \\
...
$$
\begin{align*} 
\mathbb{E} \left( Y^2 \right) &= 2 \int_{y = 0}^{y = \infty} y \exp \left( -\frac{y}{\beta} \right) \mathrm{d}y \\
&= 2 \left[ u v \Bigg|_{y = 0}^{y = \infty} - \int_{y = 0}^{y = \infty} v \mathrm{d}u \right] \\
