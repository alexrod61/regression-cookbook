...
| Distribution and <br> Parametrization | Support |  Mean  |  Variance  | 
|:------:|:-----:|:-----:|:-----:|
| **Weibull** as in <br> $Y \sim \text{Weibull}(\alpha, \beta)$ with scale <br> $\alpha \in [0, \infty)$ <br> and shape <br> $\beta \in [0, \infty)$ | $$y \in [0, \infty)$$ | $$\alpha \Gamma \left( 1 + \frac{1}{\beta} \right)$$ | $$\alpha^2 \Bigg[ \Gamma \left( 1 + \frac{2}{\beta} \right) - $$ $$ \quad \Gamma^2 \left( 1 + \frac{1}{\beta} \right) \Bigg]$$ |
...
`r colourize("Parameter", "blue")` $\lambda \in [0, \infty)$ refers to the random process' rate.
...
`r colourize("Parameter", "blue")` $\beta \in [0, \infty)$ refers to the random process' scale
