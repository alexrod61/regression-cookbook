...
| Distribution |  Parameter(s) | Support |  Mean  |  Variance  | 
|:----:|:------:|:-----:|:-----:|:-----:|
| Exponential | $Y \sim \text{Exponential}(\lambda)$ with rate $\lambda >0$ <br> or $Y \sim \text{Exponential}(\beta)$ with scale $\beta > 0$ | $y \geq 0$ | $\frac{1}{\lambda}$ <br> for rate <br> parametrization <br> or <br> $\beta$ <br> for scale <br> parametrization | $\frac{1}{\lambda^2}$ <br> for rate <br> parametrization <br> or <br> $\beta^2$ <br> for scale <br> parametrization | 
