...
2. We have highlighted the values corresponding to the red bars in five of the previous Binomial PMFs from @fig-binomial-PMFs with vertical orange dashed lines at $\pi = 0.3, 0.4, 0.5, 0.6, 0.8$; since a probability function is mathematically equivalent to a likelihood function.
...
#| fig-cap: "Binomial likelihood function of the probability of success given 10 trials and 5 observed successes."
#| warning: false
#| echo: false
#| fig.height: 7
#| fig.width: 14
...
plot_binomial_likelihood_pi <- ggplot(data = data.frame(x = c(0, 1)), aes(x)) +
  ...
  geom_segment(aes(x = 0.7, y = 0, xend = 0.7, yend = dbinom(x = 7, size = 10, prob = 0.7)), 
                   color = "darkmagenta", linetype  ="solid", linewidth = 1.1) +
