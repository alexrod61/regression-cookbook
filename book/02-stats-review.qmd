...
&= - \frac{n _D \hat{\pi}_{\text{MLE}}}{\hat{\pi}_{\text{MLE}}^2} - \frac{n_D - n_D \hat{\pi}_{\text{MLE}}}{\left( 1 - \hat{\pi}_{\text{MLE}} \right)^2} \\
&= - \frac{n _D}{\hat{\pi}_{\text{MLE}}} - \frac{n_D \left( 1 - \hat{\pi}_{\text{MLE}} \right)}{\left( 1 - \hat{\pi}_{\text{MLE}} \right)^2} \\
&= - \frac{n _D}{\hat{\pi}_{\text{MLE}}} - \frac{n_D}{1 - \hat{\pi}_{\text{MLE}}} < 0.
\end{align*}
$$
