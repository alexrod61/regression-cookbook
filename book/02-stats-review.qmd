...
Having summarized all our probabilitic elements in @tbl-queries-2, the `r colourize("parameters", "blue")` of interest must come into play for our data modelling game! Hence, the question is:
