...
To provide a clearer explanation, we will plot the PMFs of six Binomial random variables, as shown in @fig-binomial-PMFs. The following key points can be highlighted in these plots:
...
5. Lastly, the red bar highlights the specific probability $P(Y = 5 | n = 10, \pi)$. This value will be particularly important later in our proof of concept for MLE.
